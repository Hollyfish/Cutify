# Arda Kabay'ın Mobil Backend Görevleri
...
* HTTP Client kullanımı (Retrofit/OkHttp veya eşdeğer mobil HTTP kütüphaneleri)
...
* Token süresi dolmuşsa refresh token mekanizması
...
* Form validasyonu (email ve telefon formatı vb.)
...
* Conflict resolution mekanizmaları
...
* Local data cleanup (SharedPreferences, UserDefaults veya database cache)
